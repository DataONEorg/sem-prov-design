...
sncid=netcdf.open('inputs/land_cover/SYNMAP_Global_HD_new.nc', 'NC_NOWRITE');
...
for m=1:12
    tncid=netcdf.open(strcat('inputs/cruncep_Tair/cruncep_monthly_2000_2010_mean_Tair_',num2str(m),'.nc'), 'NC_NOWRITE');
...
for m=1:12
    rncid=netcdf.open(strcat('inputs/cruncep_rain/cruncep_monthly_2000_2010_mean_rain_',num2str(m),'.nc'), 'NC_NOWRITE');
    rvid=netcdf.inqVarID(rncid, 'Tair_monthly_mean');
...
moncid=netcdf.create('outputs/SYNMAP_PRESENTVEG_C3Grass_RelaFrac_Global_v2.0.nc', 'NC_CLOBBER');% create netCDF dataset (filename,mode)
...
% reuse longitude, latitude, and boundary variables from land cover input file
moncid=netcdf.create('outputs/SYNMAP_PRESENTVEG_C4Grass_RelaFrac_Global_v2.0.nc', 'NC_CLOBBER');% create netCDF dataset (filename,mode)
...
% reuse longitude, latitude, and boundary variables from land cover input file
moncid=netcdf.create('outputs/SYNMAP_PRESENTVEG_Grass_Fraction_Global_v2.0.nc', 'NC_CLOBBER');% create netCDF dataset (filename,mode)
